...
namespace IR.Chatbots.Engine.Requst.Handlers
{
    /// <summary>
                ...
                case ChatStateType.PickNode:
                    {
                        ...
                        if (nextLink == null)
                        {
                            ...
                            else
                            {
                                try
                                {
                                    var result = requestState.Predict(text);
                                    await SendReply(turnContext, result, SuggestionExtension.GetCommonSuggestionActions());
                                }
                                catch (Exception e)
                                {
