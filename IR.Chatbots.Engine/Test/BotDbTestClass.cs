...
using IR.Chatbots.Data.Models.Interfaces;
...
namespace IR.Chatbots.Engine.Test
{
    /// <summary>
    ...
    public static class BotDbTestClass
    {
        ...
        public async static Task Feed(string botId, bool dropDatabase, string profileName = BotChatProfile.DefaultProfile)
        {
            ...
            {
                Name = "SuperRoot",
                Notes = new List<string> { "Welcome to IR chatbot mobile device assistant beta version!" },
            ...
            var resourceCustomerSupport = await DbResourceCollection.InsertNew(new NeuralResourceModel
            {
                ...
                Location = "https://www.IR.co.in/c-w/support-home/support-contact-page.html",
